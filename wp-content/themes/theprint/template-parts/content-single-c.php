<?php
/**
 * The template used for displaying single content with style C.
 *
 * @package WordPress
 * @subpackage The_Print
 * @since The_Print 1.0.0
 */
?>
		...
		<div class="gp-theprint-site-main">
			<main id="content" class="gp-theprint-content single-post">
				...
				?>
					...
					<article <?php post_class( 'entry-single style-c' ); ?> itemscope="itemscope" itemtype="http://schema.org/<?php if ( get_field('gp_theprint_enable_rating') == '1' ): 
?>Review<?php else: ?><?php if ( get_option( 'gp_theprint_schema_seo' ) == 'article' ): ?>NewsArticle<?php else: ?>BlogPosting<?php endif; ?><?php endif; ?>">
						...
						<div class="entry-cover">
							...
							<header class="entry-header">
								<p class="single-entry-meta-category">
