<?php
/**
 * The template used for displaying featured content with style B.
 *
 * @package WordPress
	...
	?>
		<div class="gp-theprint-featured-posts">
			<div class="gp-theprint-articles">
				<?php 
				// Start the query.
				$featured_posts_b = new WP_Query( array(
					'showposts' => 4, 
					'meta_key' => 'gp_theprint_featured_post_add', 
					'meta_value' => '1', 
				) ); 
				?>
					<?php if ( $featured_posts_b->have_posts() ) : ?>
						<?php 
						// Start the loop.
						while( $featured_posts_b->have_posts() ): $featured_posts_b->the_post();
						?>

							<div class="gp-theprint-featured-post-b featured-post">
								<div class="featured-image">
									...
									<?php if ( has_post_thumbnail() ) : ?>
										<?php the_post_thumbnail( 'gp-theprint-589x300', array( 'alt' => the_title_attribute( 'echo=0' ) ) ); ?>
									<?php endif; ?>
							...
							</div><!-- .gp-theprint-featured-post-b -->
