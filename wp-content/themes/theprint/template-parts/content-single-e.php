<?php
/**
 * The template used for displaying single content with style E.
 *
 * @package WordPress
		...
		<div class="gp-theprint-site-main">
			<main id="content" class="gp-theprint-content single-post">
				...
				?>
					...
					<article <?php post_class( 'entry-single style-e' ); ?> itemscope="itemscope" itemtype="http://schema.org/<?php if ( get_field('gp_theprint_enable_rating') == '1' ): 
