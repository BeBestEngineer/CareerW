<?php
/**
 * The template used for displaying single content with style B.
 *
 * @package WordPress
...
<div id="main" class="gp-theprint-main">
	<div class="gp-theprint-row">
		<div class="gp-theprint-site-main">
			<main id="content" class="gp-theprint-content single-post<?php if ( get_field('gp_theprint_post_sidebar') == 'gp_theprint_post_sidebar_off' ): ?> full-width<?php endif; ?>">
				<?php 
				// Start the loop.
				while ( have_posts() ) : the_post(); 
				?>

					<article <?php post_class( 'entry-single style-b' ); ?> itemscope="itemscope" itemtype="http://schema.org/<?php if ( get_field('gp_theprint_enable_rating') == '1' ): 
