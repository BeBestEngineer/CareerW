<?php
/**
 * The template used for displaying single content with style D.
 *
 * @package WordPress
		...
		<div class="gp-theprint-site-main">
			<main id="content" class="gp-theprint-content single-post">
				...
				?>
					...
					<article <?php post_class( 'entry-single style-d' ); ?> itemscope="itemscope" itemtype="http://schema.org/<?php if ( get_field('gp_theprint_enable_rating') == '1' ): 
