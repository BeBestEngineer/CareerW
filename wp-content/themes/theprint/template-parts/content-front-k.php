<?php
/**
 * The template used for displaying content with style K.
 *
 * @package WordPress
...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class('gp-theprint-front-post-k front-post'); ?>>
		...
		<div class="featured-image">
			<?php if ( has_post_thumbnail() ): ?>
				<a href="<?php esc_url( the_permalink() ); ?>">
					<?php the_post_thumbnail( 'gp-theprint-740x440', array( 'alt' => the_title_attribute( 'echo=0' ) ) ); ?>
