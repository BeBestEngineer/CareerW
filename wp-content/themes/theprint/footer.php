...
jQuery('a.entry-link').hover(
    function(){ 
        jQuery( this ).prev('.entry-description').children('header').children('p').children('span').children('a').css({'color':'#9C9C9C'});
        jQuery( this ).prev('.entry-description').children('header').children('h2').css({'color':'#9C9C9C'});        
    },
    function(){ 
