...
class gp_theprint_load_recent_reviews_b extends WP_Widget {
	
	/* Widget setup. */

	public function __construct() {
		parent::__construct(
			'gp_theprint_recent_reviews_b', // Widget ID.
				esc_html__( '* WGP - Sidebar - Recent Reviews B', 'theprint' ), // Widget name.
				array( 
					'classname' => 'gp-theprint-recent-reviews-b', // Widget class.
					'description' => esc_html__( 'A widget that displays recent reviews with style B.', 'theprint' ), // Widget description.
				)
		);
	...
	public function widget( $args, $instance ) {
		...
		<?php endif; ?>
			...
			<?php 
			// Start the query.
			$recent_reviews_b = new WP_Query( array( 
				'showposts' => $posts, 
			...
			?>
				<?php if ( $recent_reviews_b->have_posts() ) : ?>
					<ul>
						<?php 
						// Start the loop.
						while( $recent_reviews_b->have_posts() ): $recent_reviews_b->the_post();
						?>
						
							<li class="gp-theprint-recent-review-b">
							...
							</li><!-- .gp-theprint-recent-review-b -->
...
function register_gp_theprint_load_recent_reviews_b() {
    register_widget( 'gp_theprint_load_recent_reviews_b' );
}

add_action( 'widgets_init', 'register_gp_theprint_load_recent_reviews_b' );