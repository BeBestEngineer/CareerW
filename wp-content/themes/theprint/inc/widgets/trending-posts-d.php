...
class gp_theprint_load_trending_posts_d extends WP_Widget {
	
	/* Widget setup. */

	public function __construct() {
		parent::__construct(
			'gp_theprint_trending_posts_d', // Widget ID.
				esc_html__( '* WGP - Sidebar - Trending Posts D', 'theprint' ), // Widget name.
				array( 
					'classname' => 'gp-theprint-trending-posts-d', // Widget class.
					'description' => esc_html__( 'A widget that displays trending posts with style D.', 'theprint' ), // Widget description.
				)
		);
				...
				<?php if ( $trending_posts_c->have_posts() ): ?>
					<ul>
						...
						?>
							...
							<li class="gp-theprint-trending-post-d">
							...
							</li><!-- .gp-theprint-trending-post-d -->
...
function register_gp_theprint_load_trending_posts_d() {
    register_widget( 'gp_theprint_load_trending_posts_d' );
}

add_action( 'widgets_init', 'register_gp_theprint_load_trending_posts_d' );