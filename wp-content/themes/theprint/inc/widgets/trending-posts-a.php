...
class gp_theprint_load_trending_posts_a extends WP_Widget {
	
	/* Widget setup. */

	public function __construct() {
		parent::__construct(
			'gp_theprint_trending_posts_a', // Widget ID.
				esc_html__( '* WGP - Sidebar - Trending Posts A', 'theprint' ), // Widget name.
				array( 
					'classname' => 'gp-theprint-trending-posts-a', // Widget class.
					'description' => esc_html__( 'A widget that displays trending posts with style A.', 'theprint' ), // Widget description.
				)
		);
	...
	public function widget( $args, $instance ) {
		...
		echo $args['before_widget']; ?>
			...
			<?php 
			// Start the query.
			$trending_posts_a = new WP_Query( array( 
				'showposts' => $posts, 
			...
			?>
				<?php
				// If have posts. 
				if ( $trending_posts_a->have_posts() ): 
				?>
					<ul>
						<?php 
						// Start the loop.
						while( $trending_posts_a->have_posts() ): $trending_posts_a->the_post();
						?>
							<li class="gp-theprint-trending-post-a">
							...
							</li><!-- .gp-theprint-trending-post-a -->
						<?php 
						// End the loop.
						endwhile; 
						?>
...
function register_gp_theprint_load_trending_posts_a() {
    register_widget( 'gp_theprint_load_trending_posts_a' );
}

add_action( 'widgets_init', 'register_gp_theprint_load_trending_posts_a' );