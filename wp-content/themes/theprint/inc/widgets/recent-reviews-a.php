...
class gp_theprint_load_recent_reviews_a extends WP_Widget {
	
	/* Widget setup. */

	public function __construct() {
		parent::__construct(
			'gp_theprint_recent_reviews_a', // Widget ID.
				esc_html__( '* WGP - Sidebar - Recent Reviews A', 'theprint' ), // Widget name.
				array( 
					'classname' => 'gp-theprint-recent-reviews-a', // Widget class.
					'description' => esc_html__( 'A widget that displays recent reviews with style A.', 'theprint' ), // Widget description.
				)
		);
	...
	public function widget( $args, $instance ) {
		...
		<?php endif; ?>
			...
			<?php 
			// Start the query.
			$recent_reviews_a = new WP_Query( array( 
				'showposts' => $posts, 
			...
			?>
				<?php if ( $recent_reviews_a->have_posts() ): ?>
					<ul>
						<?php 
						// Start the loop.
						while( $recent_reviews_a->have_posts() ): $recent_reviews_a->the_post();
						?>
						
							<li class="gp-theprint-recent-review-a">
							...
							</li><!-- .gp-theprint-recent-review-a -->
...
function register_gp_theprint_load_recent_reviews_a() {
    register_widget( 'gp_theprint_load_recent_reviews_a' );
}

add_action( 'widgets_init', 'register_gp_theprint_load_recent_reviews_a' );