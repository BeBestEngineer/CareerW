<?php
/**
 * Homepage widget area #3 posts with style D.
 *
 *
...
class gp_theprint_load_homepage_3_posts_d extends WP_Widget {

	/* Widget setup. */

	public function __construct() {
		parent::__construct(
			'gp_theprint_homepage_3_posts_d', // Widget ID.
				esc_html__( '* WGP - Homepage #3 - Posts D', 'theprint' ), // Widget name.
				array( 
					'classname' => 'gp-theprint-homepage-3-posts-d', // Widget class.
					'description' => esc_html__( 'A widget that displays homepage widget area #3 posts with style D.', 'theprint' ), // Widget description.
				)
		);
	...
	public function widget( $args, $instance ) {
		...
		<div class="gp-theprint-columns">
			<div class="gp-theprint-column-1">
				...
				<?php 
				// Start the query.
				$homepage_3_posts_d = new WP_Query( array( 
					'cat' => $categories,
					'showposts' => $posts,  
					'offset' => $exclude_posts,
				) ); 
				?>
					<?php if ( $homepage_3_posts_d->have_posts() ): ?>
						<ul>
							<?php $count = 0; ?>
							<?php 
							// Start the query
							$count = 0;
							while( $homepage_3_posts_d->have_posts() ): $homepage_3_posts_d->the_post(); $count++;
							?>

								<?php if ( $count == 1 ): ?>

									<li class="gp-theprint-homepage-3-post-d style-a">
									...
									</li><!-- .gp-theprint-homepage-3-post-d -->

								<?php else: ?>

									<li class="gp-theprint-homepage-3-post-d style-b">
										<header class="entry-header">
			...
			<div class="gp-theprint-column-2">
				...
				<?php 
				// Start the query.
				$second_homepage_3_posts_d = new WP_Query( array(
					'cat' => $second_categories,  
					'showposts' => $posts, 
					'offset' => $exclude_posts,
				) ); 
				?>
					<?php if ( $second_homepage_3_posts_d->have_posts() ): ?>
						<ul>
							<?php 
							// Start the loop.
							$count = 0;
							while( $second_homepage_3_posts_d->have_posts() ): $second_homepage_3_posts_d->the_post(); $count++;
							?>
			...
			<div class="gp-theprint-column-3">
				...
				<?php 
				// Start the query.
				$third_homepage_3_posts_d = new WP_Query( array( 
					'cat' => $third_categories, 
					'showposts' => $posts, 
					'offset' => $exclude_posts,
				) ); 
				?>
					<?php if ( $third_homepage_3_posts_d->have_posts() ) : ?>
						<ul>
							<?php 
							// Start the loop.
							$count = 0;
							while( $third_homepage_3_posts_d->have_posts() ): $third_homepage_3_posts_d->the_post(); $count++;
							?>
			...
			<div class="gp-theprint-column-4">
				...
				<?php 
				// Start the query.
				$fourth_homepage_3_posts_d = new WP_Query( array( 
					'cat' => $fourth_categories, 
					'showposts' => $posts, 
					'offset' => $exclude_posts,
				) ); 
				?>
					<?php if ( $fourth_homepage_3_posts_d->have_posts() ) : ?>
						<ul>
							<?php 
							// Start the loop.
							$count = 0;
							while( $fourth_homepage_3_posts_d->have_posts() ): $fourth_homepage_3_posts_d->the_post(); $count++;
							?>
...
function register_gp_theprint_load_homepage_3_posts_d() {
    register_widget( 'gp_theprint_load_homepage_3_posts_d' );
}

add_action( 'widgets_init', 'register_gp_theprint_load_homepage_3_posts_d' );