<?php
/**
 * Homepage widget area #2 posts with style E.
 *
 *
...
class gp_theprint_load_homepage_2_posts_e extends WP_Widget {
	
	/* Widget setup. */

	public function __construct() {
		parent::__construct(
			'gp_theprint_homepage_2_posts_e', // Widget ID.
				esc_html__( '* WGP - Homepage #2 - Posts E', 'theprint' ), // Widget name.
				array( 
					'classname' => 'gp-theprint-homepage-2-posts-e', // Widget class.
					'description' => esc_html__( 'A widget that displays homepage widget area #2 posts with style E.', 'theprint' ), // Widget description.
				)
		);
	...
	public function widget( $args, $instance ) {
		...
		<?php endif; ?>
			...
			<?php 
			// Start the query.
			$homepage_2_posts_e = new WP_Query( array( 
				'cat' => $categories, 
				'showposts' => $posts, 
				'offset' => $exclude_posts,
			) ); 
			?>
				<?php if ( $homepage_2_posts_e->have_posts() ): ?>
					<ul>
						<?php 
						// Start the loop.
						while( $homepage_2_posts_e->have_posts() ): $homepage_2_posts_e->the_post();
						?>

							<li class="gp-theprint-homepage-2-post-e">
							...
							</li><!-- .gp-theprint-homepage-2-post-e -->
...
function register_gp_theprint_load_homepage_2_posts_e() {
    register_widget( 'gp_theprint_load_homepage_2_posts_e' );
}

add_action( 'widgets_init', 'register_gp_theprint_load_homepage_2_posts_e' );