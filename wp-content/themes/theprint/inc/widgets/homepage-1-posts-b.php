<?php
/**
 * Homepage widget area #1 posts with style B.
 *
 *
...
class gp_theprint_load_homepage_1_posts_b extends WP_Widget {
	
	/* Widget setup. */

	public function __construct() {
		parent::__construct(
			'gp_theprint_homepage_1_posts_b', // Widget ID.
				esc_html__( '* WGP - Homepage #1 - Posts B', 'theprint' ), // Widget name.
				array( 
					'classname' => 'gp-theprint-homepage-1-posts-b', // Widget class.
					'description' => esc_html__( 'A widget that displays homepage widget area #1 posts with style B.', 'theprint' ), // Widget description.
				)
		);
	...
	public function widget( $args, $instance ) {
		...
		<?php endif; ?>
			...
			<?php 
			// Start the query.
			$homepage_1_posts_b = new WP_Query( array(  
				'cat' => $categories, 
				'showposts' => $posts,
				'offset' => $exclude_posts,
			) ); 
			?>
				<?php if ( $homepage_1_posts_b->have_posts() ): ?>
					<ul>
						<?php
						// Start the loop.
						while( $homepage_1_posts_b->have_posts() ): $homepage_1_posts_b->the_post(); 
						?>

							<li class="gp-theprint-homepage-1-post-b">
								<div class="featured-image">
									...
									<a class="entry-link" href="<?php esc_url( the_permalink() ); ?>"></a>
								</div><!-- .featured-image -->
							</li><!-- .gp-theprint-homepage-1-post-b -->
...
function register_gp_theprint_load_homepage_1_posts_b() {
    register_widget( 'gp_theprint_load_homepage_1_posts_b' );
}

add_action( 'widgets_init', 'register_gp_theprint_load_homepage_1_posts_b' );