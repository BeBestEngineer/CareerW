...
<?php if ( get_option( 'gp_theprint_single_entry_share_enable' ) != '' ): ?>

<div class="single-entry-share<?php if ( get_option( 'gp_theprint_single_sticky_entry_share' ) != '' ) : ?> sticky-share<?php endif; ?>">
	<ul>
