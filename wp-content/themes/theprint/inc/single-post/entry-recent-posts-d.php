<?php
/**
 * The template used for displaying recent posts with style D.
 *
 * @package WordPress
...
<div class="entry-recent-posts style-d">
	<h4 class="gp-theprint-block-title"><?php esc_html_e( 'Recent Posts', 'theprint' ); ?></h4>

	<?php 
	// Start the query.
	$entry_recent_posts = new WP_Query( array( 'showposts' => 5 ) ); 
	?>
		<?php if( $entry_recent_posts->have_posts() ) : ?>
		   	...
		   	?>
		    	...
		    	<div class="entry-recent-post style-d">
					...
					<div class="entry-description">
						...
						<div class="entry-excerpt">
							<p><?php $content = get_the_content(); $trimmed_content = wp_trim_words( $content, 35, '...' ); echo $trimmed_content; ?></p>
						</div><!-- .entry-excerpt -->
